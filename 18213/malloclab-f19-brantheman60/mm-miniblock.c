...
static const size_t chunksize_small = (1 << 12);
...
#define SIZE1 32                   // max size of block in free list 1
#define SIZE2 64                   // max size of block in free list 2
#define SIZE3 256                  // max size of block in free list 3
#define SIZE4 1024                 // max size of block in free list 4
#define SIZE5 2048                 // max size of block in free list 4
#define SIZE6 4096                 // max size of block in free list 5
#define SIZE7 16384                // max size of block in free list 6
...
static block_t *coalesce_block(block_t *block) {
  ...
  dbg_printf("block_prev = %p, block = %p, block_next = %p\n", block_prev,
             block, block_next);
  dbg_printf("get_prev_mini(block) = %d\n", get_prev_mini(block));
